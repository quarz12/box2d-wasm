!function (root) {
  ...
  if (typeof define === 'function' && define.amd) {
    ...
    /** @type {Promise<import('testbed/demo/modern/public/box2d-wasm/dist/Box2DModule')>} */
    const modulePromise = loadModule(`${box2DDir}/${moduleName}.js`, 'Box2D');
    /**
     * @param {Parameters<import('testbed/demo/modern/public/box2d-wasm/dist/Box2DModule')>} args
     * @return {ReturnType<import('testbed/demo/modern/public/box2d-wasm/dist/Box2DModule')>}
     */
